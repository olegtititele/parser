...
popup_balance_btn = InlineKeyboardButton("💵 Пополнить баланс⛔️DON'T WORK", callback_data='popup_balance')
settings_btn = InlineKeyboardButton("⚙️ Настройки⛔️DON'T WORK", callback_data='settings')
