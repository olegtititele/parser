...
popup_balance_btn = InlineKeyboardButton("💵⛔️DON'T WORK Пополнить баланс", callback_data='popup_balance')
settings_btn = InlineKeyboardButton("⚙️⛔️DON'T WORK Настройки", callback_data='settings')
